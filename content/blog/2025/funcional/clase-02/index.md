...
- Instalarse [Haskell](https://www.pdep.com.ar/software/haskell#h.5abhtoqqug3d) **SIN PdePreludat** y [Visual Studio Code](https://code.visualstudio.com/download).
- Resolver el ejercicio [PdeP - commerce](https://docs.google.com/document/d/1kjXQ24yGqdvrXWqGT-7T2hCd8o10uz738N5NDROhfI0/edit#) para ir practicando. Pueden escribir un archivo con extensión `.hs` en el VS Code y luego, en la terminal que pueden abrir ahí mismo, probar lo que hicieron con el comando `stack ghci <archivo>`.
